...
create index oe.idx_rev_cust_id
on oe.cust_idx_test(customer_id) reverse 
tablespace idx_cust_test_tbs;

EXEC DBMS_STATS.gather_index_stats('OE', 'IDX_REV_CUST_ID');
...
select customer_id, cust_last_name 
from oe.cust_idx_test
where customer_id between 200 and 250;
set autotrace off
