...
create bitmap index oe.bit_idx_cust_id
on oe.cust_idx_test(gender) tablespace idx_cust_test_tbs;

EXEC DBMS_STATS.gather_index_stats('OE', 'BIT_IDX_CUST_ID');
EXEC DBMS_STATS.gather_table_stats('OE', 'CUST_IDX_TEST');
